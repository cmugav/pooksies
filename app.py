...
def love_story():
    ...
    <body>
      ...
      <div id="start" class="page active">
        ...
        <img src="/static/img_0835.jpeg" alt="Beautiful afternoon">
        ...
        <img src="/static/img_1379.jpeg" alt="Us at the beach looking happy and silly">
      </div>
      ...
      <div id="fell" class="page">
        ...
        <img src="/static/img_2724.jpg" alt="Don't be a stranger, okay?">
        ...
        <img src="/static/besito.jpg" alt="Our first photo after our first kiss">
        ...
        <img src="/static/camita.jpg" alt="Us laying in bed in the second Airbnb">
        ...
        <img src="/static/img_3859.jpg" alt="Our hike together">
        <img src="/static/img_4598.jpeg" alt="Silly, silly, silly girls">
      </div>
      ...
      <img src="/static/img_8946.jpg" alt="Smoking sesh">

      <p>Some crying sessions too...</p>
      <img src="/static/img_7678.jpg" alt="Crying sesh">

      <p>And, finally... our first reunion :)</p>
      <img src="/static/maas.jpg" alt="You look so peaceful in this one">
      ...
      <img src="/static/img_6614.jpeg" alt="Airport">
    ...
    <div id="now" class="page">
      ...
      <img src="/static/img_7712.png" alt="Distance">
