...
def love_story():
    ...
    <body>
      ...
      <div id="start" class="page active">
        ...
        <img src="{{ url_for('static', filename='Captura de pantalla 2025-05-21 a la(s) 21.46.06.png') }}" alt="You eating a McFlurry at McDonalds after Sala Gente">
      ...
      <div id="fell" class="page">
        ...
        <img src="{{ url_for('static', filename='8f11fdcd-cb44-4f5c-bc38-aef8bb3ef313.jpg') }}" alt="Christi's birthday">
        ...
        <img src="{{ url_for('static', filename='AADC377B-BCAF-4661-B88A-A0B52E71D002.jpg') }}" alt="Our first photo after our first kiss">
        ...
        <img src="{{ url_for('static', filename='FEEB5EE4-CC2E-4A61-9AD8-0CB7BEC46F4D.jpg') }}" alt="Us laying in bed in the second Airbnb">
      ...
      <img src="{{ url_for('static', filename='DAE27E4C-7BA0-4595-9BDE-760428348A6D.jpg') }}" alt="You look so peaceful in this one">
      <img src="{{ url_for('static', filename='Fujifilm 200 31.jpg') }}" alt="Pretty girl">
